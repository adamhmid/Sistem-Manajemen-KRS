...
@section('content')
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">{{ __('Create Mata Kuliah') }}</div>
          <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="kode_mk" type="text" class="form-control @error('kode_mk') is-invalid @enderror" name="kode_mk"
                    value="{{ old('kode_mk') }}" required autocomplete="kode_mk" autofocus>
                  @error('kode_mk')
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="nama_mk" type="text" class="form-control @error('nama_mk') is-invalid @enderror" name="nama_mk"
                    value="{{ old('nama_mk') }}" required autocomplete="nama_mk" autofocus>
                  @error('nama_mk')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
